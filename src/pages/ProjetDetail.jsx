...
import { ArrowLeft, Target, Zap, BarChart2, FileText, Download, Send, Globe, ExternalLink, ChevronLeft, ChevronRight } from 'lucide-react'
...
function ImagePlaceholder({ initiale, couleur }) {
  return (
    <div
      ...
      style={{ backgroundColor: couleur, minHeight: '280px' }}
    >
...
export default function ProjetDetail() {
  ...
  const handleTouchEnd = (e) => {
    ...
    if (diff > 0 && nextProjet) goTo(nextProjet.id)
    if (diff < 0 && prevProjet) goTo(prevProjet.id)
  ...
  const navBtnStyle = (active) => ({
    ...
    backgroundColor: active ? '#fff' : '#f5f4ee',
    color: active ? '#1a4d2e' : '#ccc',
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 z-50 bg-white border-b" style={{ borderColor: '#ede7d5' }}>
        <div className="max-w-6xl mx-auto px-4 md:px-6 py-3 md:py-4 flex items-center justify-between gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-[13px] font-semibold hover:opacity-70 transition-opacity flex-shrink-0"
            style={{ color: '#1a4d2e' }}
          >
            <ArrowLeft size={15} />
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={!prevProjet}
              className="flex items-center gap-1.5 px-2.5 md:px-3 py-2 rounded-xl text-[12px] font-semibold transition-all"
              style={navBtnStyle(!!prevProjet)}
            >
              <ChevronLeft size={14} />
            ...
            <span className="text-[12px] font-medium whitespace-nowrap" style={{ color: '#888' }}>
      ...
      <div className="max-w-6xl mx-auto px-5 md:px-6 py-8 md:py-12 flex flex-col gap-8 md:gap-12">
        ...
        <div className="flex flex-col gap-2">
          ...
          <h1 className="font-extrabold leading-tight uppercase"
            style={{ color: '#1a1a1a', fontSize: 'clamp(2rem, 6vw, 3.75rem)' }}>
            {projet.titre}
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 md:items-start">
          ...
          <div className="flex items-start md:py-4">
            {projet.espaceTexte
              ? <p className="text-[15px] md:text-[16px] leading-relaxed" style={{ color: '#1a1a1a' }}>{projet.espaceTexte}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          {/* Objectifs */}
          <div className="rounded-3xl p-5 md:p-6 flex flex-col gap-4" style={{ backgroundColor: '#fff', border: '1px solid #ede7d5' }}>
        ...
        {projet.showPdf !== false && (
          <div className="rounded-3xl p-5 md:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4"
            ...
            {projet.pdfNom && (
              <div className="flex items-center gap-3 px-4 py-3 rounded-2xl" style={{ backgroundColor: '#f5f4ee', border: '1px solid #e0ddd6' }}>
            ...
            <a href={projet.pdf || '#'} download
              className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-2xl text-white text-[13px] font-semibold transition-opacity hover:opacity-90 flex-shrink-0"
        ...
        {projet.lienUrl && (
          <div className="rounded-3xl p-5 md:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4"
            ...
            <div className="flex items-center gap-3 px-4 py-3 rounded-2xl overflow-hidden" style={{ backgroundColor: '#f5f4ee', border: '1px solid #e0ddd6' }}>
              <Globe size={16} style={{ color: '#6b9e7e' }} strokeWidth={1.5} />
              <p className="text-[12px] font-semibold truncate" style={{ color: '#1a1a1a' }}>{projet.lienUrl}</p>
            </div>
        ...
        <div className="rounded-3xl overflow-hidden"
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4 p-5 md:p-0">
            ...
            <div className="hidden md:block flex-shrink-0 w-1 rounded-full" style={{ backgroundColor: '#1a4d2e', height: '56px' }} />
