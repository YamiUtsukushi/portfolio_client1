...
const EXPERIENCES = [
  {
    ...
    missions: [
      ...
      'Suivi des performances : KPI, visibilité et engagement.',
      'Intégration des enjeux RSE dans les supports et actions de marque.',
      'Contribution à la notoriété de l\'association et à la visibilité auprès des partenaires.',
    ],
  },
  {
    id: 2,
    ...
    lieu: 'Courbevoie',
    date: '2022 – 2023',
    logoSrc: '/assets/logo-atmosphere.png',
    missions: [
      'Pilotage opérationnel et stratégique de projets marketing.',
      'Coordination de projets transverses en lien direct avec la direction générale.',
      'Encadrement et coordination d\'équipes internes pluridisciplinaires.',
      'Mise en œuvre de la stratégie RSE dans les supports et actions de marque.',
      'Renforcement du positionnement auprès de clients premium : luxe, hôtellerie, retail.',
    ],
  },
  {
    id: 3,
    ...
    missions: [
      ...
      'Suivi des résultats : ventes, fréquentation et impact des actions.',
      'Coordination avec les équipes terrain pour assurer le bon déroulement des opérations.',
      'Contribution à l\'expérience client et à la fidélisation.',
    ],
  },
  {
    id: 4,
    ...
    missions: [
      ...
      'Participation à la fidélisation et au suivi de la relation client.',
    ],
  },
  {
    id: 5,
    ...
    missions: [
      ...
      'Adaptation rapide, autonomie et montée en responsabilité.',
    ],
  },
]
